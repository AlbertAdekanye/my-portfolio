    ...
    let steps = [
        {
            ...
            description:
                "Tesla Clone is a responsive web application created with <strong class='text-violet-400'>React.js</strong>, <strong class='text-violet-400'>TailwindCSS</strong> & <strong class='text-violet-400'>Firebase</strong> that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices.",
        },
        {
            name: "Realtor Clone",
            icon: "fa-solid fa-house-user",
            description:
                "Realtor Clone is a Full Stack <strong class='text-violet-400'>Next.js</strong>, <strong class='text-violet-400'>Node.js + Express.js</strong> & <strong class='text-violet-400'>Firebase</strong> CRUD application that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices.",
        },
        {
            name: "Bookmark Manager Landing Page",
            icon: "fa-solid fa-bookmark",
            description:
                "Bookmark Manager Landing Page is a responsive web application created with <strong class='text-violet-400'>SvelteKit</strong> & <strong class='text-violet-400'>TailwindCSS</strong> that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices",
        },
    ];
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="mx-auto font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-cyan-400">Albert</span> Adekanye
                <br />Frontend
            ...
            <button
                class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-cyan-600 text-white hover:bg-white hover:text-black duration-200"
            >
                <div
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                  Tesla Clone is a responsive web application created with <strong class='text-cyan-400'>React.js</strong>, <strong class='text-cyan-400'>TailwindCSS</strong> & <strong class='text-cyan-400'>Firebase</strong> that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Realtor Clone is a Full Stack <strong class='text-cyan-400'>Next.js</strong>, <strong class='text-cyan-400'>Node.js + Express.js</strong> & <strong class='text-cyan-400'>Firebase</strong> CRUD application that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices.
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                   Bookmark Manager Landing Page is a responsive web application created with <strong class='text-cyan-400'>SvelteKit</strong> & <strong class='text-cyan-400'>TailwindCSS</strong> that allows a user to login, manage a tidy and efficacious todo list, and persist this information across devices!
                </p>
            </Step>
        </div>
    </section>
    ...
    >
        ...
        <div
            class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-cyan-100 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-cyan-700 py-4"
        >
            <h6 class="text-large sm:text-xl md:text-2xl">
                Want to know more?
            </h6>
